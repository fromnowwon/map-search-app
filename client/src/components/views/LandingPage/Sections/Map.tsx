...
const Map = (props: propsType) => {
	...
	useEffect(() => {
		...
		function getListItem(index: number, places: placeType) {
			...
			let itemStr = `
				<div class="info">
					<span class="marker marker_${index+1}">${index+1}</span>
			...
			<div className="flex-grid flex-grid--wrap">
				...
				<div id="search-result" className="search-result">
					...
					<div className="scroll-wrapper">
						<ul id="places-list" className="places-list">
						</ul>
					</div>
					<div id="pagination" className="pagination flex-grid flex-grid--center"></div>
				</div>
			</div>
		</div>
	)
